...
# 9 examples are developed and compatible with Visual Studio and Qt creator IDEs:
	...
	-	1 example with USB DFU bootloader for MCU based devices
	-	1 example with UART bootloader
	-	1 example with USB DFU for MPU based devices
